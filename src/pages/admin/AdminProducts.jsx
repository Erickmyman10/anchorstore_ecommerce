...
const AdminProducts = () => (
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <h1 className="text-2xl font-extrabold text-gray-900 mb-1">Product Management</h1>
    <p className="text-sm text-gray-400 mb-10">Add, edit, and manage your product catalogue.</p>
    ...
    <div className="flex flex-col items-center justify-center py-24 text-gray-400 border-2 border-dashed border-gray-200 rounded-2xl">
      ...
      <p className="font-semibold text-gray-500">Product management coming soon</p>
